/*
    ...
    UV좌표: 임의의 텍스처의 texel을 임의의 면에 임의의 지점에 대응시키기 위한 좌표정보
        <-- 정규화되어 있다.
            ( 정규화의 이유: 크기가 제각각 모두 다른 텍스처들을 일반화하여 다루기 위해서다 )
...
Shader "Ryu/shUVAni"
{
    ...
    SubShader
    {
        ...
        void surf (Input IN, inout SurfaceOutput o)
        {
            ...
            //tex2D셰이더 함수: UV좌표를 참고하여, 텍스처 이미지 데이터에서 임의의 텍셀을 가져오는 함수<--샘플링sampling
            ...
            //<-- UV animation기법 : UV 좌표값을 조작함으로써 텍스처를 애니메이션 시키는 것이다.
